...
describe("Validar Home Page", () => {
  ...
  it("Deve validar o Footer", () => {
    cy.validar_div();
    cy.validateAboutUsSection(
      validation_data_footer.title,
      validation_data_footer.text
    );
    cy.validateGetInTouchSection(
      validation_data_footer.get_touch,
      validation_data_footer.adress,
      validation_data_footer.telephone,
      validation_data_footer.email
    );
  ...
  it("Deve validar o header", () => {
    ...
    cy.validar_links(
      validation_data_header.menu.contact,
      validation_data_header.links.deful
    );
    cy.validar_links(
      validation_data_header.menu.about,
      validation_data_header.links.deful
    );
    cy.validar_links(
    ...
    cy.validar_links(
      validation_data_header.menu.login,
      validation_data_header.links.deful
    );
    cy.validar_links(
      validation_data_header.menu.sigin,
      validation_data_header.links.deful
    );
  });
});
